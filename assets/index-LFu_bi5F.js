(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const c of n.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&a(c)}).observe(document,{childList:!0,subtree:!0});function r(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(o){if(o.ep)return;o.ep=!0;const n=r(o);fetch(o.href,n)}})();const s=t=>document.querySelector(t),d=async t=>{try{const e=await fetch(t);if(!e.ok)throw new Error("Network response was not ok");return await e.json()}catch(e){console.error("Error fetching data:",e)}},f=async()=>await d("https://pokeapi.co/api/v2/pokemon?limit=100000&offset=0"),m=async t=>await d(t),p=(t,e)=>{for(const r in e)t.style[r]=e[r]},l=t=>t.charAt(0).toUpperCase()+t.slice(1),u="allPokemon",h=(t,e)=>{localStorage.setItem(t,JSON.stringify(e))},g=t=>{try{return JSON.parse(localStorage.getItem(t))}catch(e){return console.error(e),null}},i=()=>g(u)||[],y=async()=>{i().length||h(u,await f()),console.log(localStorage)},v=(t,e)=>e.filter(r=>{const a=new RegExp(t,"gi");return r.name.match(a)}),w=t=>{console.log(t);const e=document.createElement("div");e.className="modal-bg",e.style.display="flex",e.innerHTML=`
      ...
      <h3>${l(t.name)} #0003</h3>
       This pokemon can be found in the following version(s) of the Pokemon games:
        ...
        ${t.game_indices.map(r=>`
          <p class='gameText'>${l(r.version.name)}</p>
          `).join("")}
        </div>
        <div>
      ...
      </div>`,s("body").appendChild(e),s(".close").addEventListener("click",r=>{e.parentNode.removeChild(e)})},b=async t=>{t.preventDefault();const e=v(t.target.id,i().results),r=await m(e[0].url);w(r)},k=async(t,e)=>{const r=await m(t),a=e<10?`000${e+1}`:e<100?`00${e+1}`:e<1e3?`0${e+1}`:`${e+1}`,o=document.createElement("div");o.className="eachPokeBox",o.innerHTML=`
    <h3>${l(r.species.name)} #${a}</h3>
...
`,p(o,{"font-size":"0.85em",color:"blue","background-color":"coral",padding:"10px",margin:"1em",width:"20%","border-radius":"1em"}),s("#main").append(o),s(`#${r.name}`).addEventListener("click",b)},L=()=>{s("body").innerHTML=`
  <header>
  ...
  `,i().results.forEach(async(t,e)=>{await k(t.url,e)})},P=()=>{console.log(i()),y(),L()};P();
